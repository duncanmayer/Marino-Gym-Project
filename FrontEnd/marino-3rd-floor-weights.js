fetch('http://54.152.20.175:5000/')
    ...
    .then((json) => {
        let sun = json.filter((item) => item.Location === 'Marino Third Floor Weight Room'
                                        && item.Weekday === 'Sunday'
        );
        let mon = json.filter((item) => item.Location === 'Marino Third Floor Weight Room'
                                        && item.Weekday === 'Monday'
        );
        let tue = json.filter((item) => item.Location === 'Marino Third Floor Weight Room'
                                        && item.Weekday === 'Tuesday'
        );
        let wed = json.filter((item) => item.Location === 'Marino Third Floor Weight Room'
                                        && item.Weekday === 'Wednesday'
        );
        let thu = json.filter((item) => item.Location === 'Marino Third Floor Weight Room'
                                        && item.Weekday === 'Thursday'
        );
        let fri = json.filter((item) => item.Location === 'Marino Third Floor Weight Room'
                                        && item.Weekday === 'Friday'
        );
        let sat = json.filter((item) => item.Location === 'Marino Third Floor Weight Room'
        ...
        var layout = {
            title: 'Marino Center- 3rd Floor Weight Room',
            legend: {
        ...
        Plotly.newPlot('marino-3rd-floor-weights', data, layout);
    });