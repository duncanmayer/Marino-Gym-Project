fetch('http://54.152.20.175:5000/')
    ...
    .then((json) => {
        let sun = json.filter((item) => item.Location === 'Marino Track'
                                        && item.Weekday === 'Sunday'
        );
        let mon = json.filter((item) => item.Location === 'Marino Track'
                                        && item.Weekday === 'Monday'
        );
        let tue = json.filter((item) => item.Location === 'Marino Track'
                                        && item.Weekday === 'Tuesday'
        );
        let wed = json.filter((item) => item.Location === 'Marino Track'
                                        && item.Weekday === 'Wednesday'
        );
        let thu = json.filter((item) => item.Location === 'Marino Track'
                                        && item.Weekday === 'Thursday'
        );
        let fri = json.filter((item) => item.Location === 'Marino Track'
                                        && item.Weekday === 'Friday'
        );
        let sat = json.filter((item) => item.Location === 'Marino Track'
